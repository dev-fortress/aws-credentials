...
class NXCModule:
    ...
    def __init__(self):
        self.search_path = "'C:\\Users\\', 'C:\\ProgramData\\AWSCLI\\', 'C:\\Temp\\'"
    ...
    def on_admin_login(self, context, connection):
        ...
        search_aws_creds_files_payload = f"Get-ChildItem -Path {self.search_path} -Recurse -Force -Include ('credentials','credentials.bk','config','config.bk') -ErrorAction SilentlyContinue | Select FullName -ExpandProperty FullName"
